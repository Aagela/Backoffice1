...
import nuxt_plugin_plugin_16d59600 from 'nuxt_plugin_plugin_16d59600' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_7e522945 from 'nuxt_plugin_bootstrapvue_7e522945' // Source: ./bootstrap-vue.js (mode: 'all')
import nuxt_plugin_pluginclient_18c73d08 from 'nuxt_plugin_pluginclient_18c73d08' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_5955d304 from 'nuxt_plugin_pluginserver_5955d304' // Source: ./content/plugin.server.js (mode: 'server')
import nuxt_plugin_axios_adae7dd4 from 'nuxt_plugin_axios_adae7dd4' // Source: ./axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"EnSmartEV Project"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"},{"rel":"stylesheet","href":"https:\u002F\u002Fapi.mapbox.com\u002Fmapbox-gl-js\u002Fv2.3.1\u002Fmapbox-gl.css"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_16d59600 === 'function') {
    await nuxt_plugin_plugin_16d59600(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_7e522945 === 'function') {
    await nuxt_plugin_bootstrapvue_7e522945(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_18c73d08 === 'function') {
    await nuxt_plugin_pluginclient_18c73d08(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_5955d304 === 'function') {
    await nuxt_plugin_pluginserver_5955d304(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_adae7dd4 === 'function') {
    await nuxt_plugin_axios_adae7dd4(app.context, inject)
  }
