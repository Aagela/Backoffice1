export const menuItems = [
    ...
    {
        id: 21,
        label: "menuitems.stations.text",
        icon: "uil-book-alt",
        subItems: [
            {
                id: 22,
                label: "menuitems.stations.list.usergrid",
                link: "/contacts/grid",
                parentId: 21
            },
            {
                id: 23,
                label: "menuitems.stations.list.userlist",
                link: "/contacts/list",
                parentId: 21
            },
            {
                id: 24,
                label: "menuitems.stations.list.profile",
    ...
    },
    {
        ...
        subItems: [
            {
                id: 27,
                label: "menuitems.users.list.login",
                link: "/auth/login-1",
                parentId: 26
            },
            {
                id: 28,
                label: "menuitems.users.list.register",
                link: "/auth/register-1",
                parentId: 26
            },
            {
                id: 29,
                label: "menuitems.users.list.recoverpwd",
                link: "/auth/recoverpwd",
                parentId: 26
            },
            {
                id: 30,
                label: "menuitems.users.list.lockscreen",
