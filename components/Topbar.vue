...
export default {
    data() {
        return {
            languages: [{
                    flag: require("~/assets/images/flags/uk.jpg"),
                    language: "en",
                    title: "English",
                },
                {
        ...
        <div class="d-flex">
            ...
            <b-dropdown class="d-inline-block" toggle-class="header-item" right variant="white" menu-class="dropdown-menu-end">
                <template v-slot:button-content>
                    ...
                    <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">{{ $t('navbar.dropdown.hamza.text')}}</span>
                ...
                <a class="dropdown-item" href="#">
                    ...
                    <span class="align-middle">{{ $t('navbar.dropdown.hamza.list.profile') }}</span>
                </a>
                <!-- <a class="dropdown-item" href="#">
                    <i class="uil uil-wallet font-size-18 align-middle me-1 text-muted"></i>
                    <span class="align-middle">{{ $t('navbar.dropdown.hamza.list.mywallet') }}</span>
                </a> -->
                <a class="dropdown-item d-block" href="#">
                    <i class="uil uil-cog font-size-18 align-middle me-1 text-muted"></i>
                    <span class="align-middle">{{ $t('navbar.dropdown.hamza.list.settings') }}</span>
                ...
                <!-- <a class="dropdown-item" href="#">
                    ...
                    <span class="align-middle">{{ $t('navbar.dropdown.hamza.list.lockscreen') }}</span>
                </a> -->
                <a class="dropdown-item" @click="logoutUser" href="javascript: void(0);">
                    <i class="uil uil-sign-out-alt font-size-18 align-middle me-1 text-muted"></i>
                    <span class="align-middle">{{ $t('navbar.dropdown.hamza.list.logout') }}</span>
                </a>
            </b-dropdown>
