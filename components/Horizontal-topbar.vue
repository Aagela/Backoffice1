        ...
        >
          <template v-slot:button-content>
            ...
            <span
              ...
              >{{ $t("navbar.dropdown.hamza.text") }}</span
            >
          ...
          <a class="dropdown-item" href="#">
            ...
            <span class="align-middle">{{
              $t("navbar.dropdown.hamza.list.profile")
            }}</span>
          </a>
          <a class="dropdown-item" href="#">
            <i
            ...
            ></i>
            <span class="align-middle">{{
              $t("navbar.dropdown.hamza.list.mywallet")
            }}</span>
          </a>
          <a class="dropdown-item d-block" href="#">
            ...
            ></i>
            <span class="align-middle">{{
              $t("navbar.dropdown.hamza.list.settings")
            }}</span>
          ...
          <a class="dropdown-item" href="#">
            ...
            ></i>
            <span class="align-middle">{{
              $t("navbar.dropdown.hamza.list.lockscreen")
            }}</span>
          </a>
          <a
            class="dropdown-item"
          ...
          >
            ...
            ></i>
            <span class="align-middle">{{
              $t("navbar.dropdown.hamza.list.logout")
            }}</span>
          </a>
        </b-dropdown>
