            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <img src="~/assets/images/users/avatar-6.jpg" alt class="avatar-lg rounded-circle img-thumbnail" />
                        </div>
                        <h5 class="mt-3 mb-1">Hamza</h5>
                    ...
                    <div class="text-muted">
                        ...
                        <p>Hi I'm Hamza,has been the industry's standard dummy text To an English person, it will seem like simplified English, as a skeptical Cambridge.</p>
                        <div class="table-responsive mt-4 mb-0">
                            <div>
                                <p class="mb-1">Name :</p>
                                <h5 class="font-size-16">Hamza</h5>
                            </div>
                            <div class="mt-4">
                                <p class="mb-1">Mobile :</p>
                                <h5 class="font-size-16">078-234-5678</h5>
                            </div>
                            <div class="mt-4">
                                <p class="mb-1">E-mail :</p>
                                <h5 class="font-size-16">hamza@evsmart.com</h5>
                            </div>
                            <div class="mt-4">
                                <p class="mb-1">Location :</p>
                                <h5 class="font-size-16">Huddersfield, United Kingdom</h5>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <ul class="activity-feed mb-0 pl-2">
                                    <li class="feed-item">
                                        <div class="feed-item-list">
                                            <p class="text-muted mb-1">2019 - 2022</p>
                                    ...
                                    <table class="table table-nowrap table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">02</th>
                                                <td>
                                                    <a href="#" class="text-dark">EnSmartEv Admin</a>
                                                </td>
                                                <td>06 Jun, 2022</td>
                                                <td>
                                                    <span class="badge bg-soft-primary font-size-12">Open</span>
                                            ...
                                            <tr>
                                                <th scope="row">04</th>
                                                <td>
                                                    <a href="#" class="text-dark">EnSmartEv Landing</a>
                                                </td>
                                                <td>13 May, 2022</td>
                                                <td>
                                                    <span class="badge bg-soft-success font-size-12">Complete</span>
