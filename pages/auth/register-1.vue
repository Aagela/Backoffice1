                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Get your free EnSmartEv account now.</p>
                            </div>
                            <div class="p-2 mt-4">
                                <form @submit.prevent="handleSubmit"> 
                                    <div class="mb-3">
                                        <label for="useremail">Email</label>
                                        <input type="email" class="form-control" v-model="useremail" id="useremail" placeholder="Enter email" />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control"  v-model="userpassword" id="userpassword" placeholder="Enter password" />
                                    </div>
                                    ...
                                    <!-- consider conditional rendering for incomplete user details -->
